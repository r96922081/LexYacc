...
";
    ...
    {
        string line1 = "a: b 'A' | 'X';"; // a: a 'B' 'A' | 'X'
        string line2 = "b: a 'B' ; ";
    ...
    public static void UtFeed27()
    {
        ...
        Yacc yacc = new Yacc(line0 + line1 + line2);
    ...
    public static void UtFeed28_empty_rule()
    {
        string line0 = "a: 'A' b {};";
        string line1 = "b: 'B' {} | {};";


        Yacc yacc = new Yacc(line0 + line1);
    ...
    public static void UtFeed29_empty_rule()
    {
        string line0 = "a: 'A' b {};";
        string line1 = "b: {} | 'B' {} ;";
